...
const shallowPropertyComparator = compose({}).mixin(shallowPropertyComparisonMixin)();
registerSuite({
	name: 'mixins/shallowPropertyComparisonMixin',
		'no updated properties'() {
			const properties = { id: 'id', foo: 'bar' };
			const updatedKeys = shallowPropertyComparator.diffProperties(<any> { id: 'id', foo: 'bar' }, properties);
		...
		'updated / new properties with falsy values'() {
			...
			const updatedKeys = shallowPropertyComparator.diffProperties(<any> { id: 'id', foo: 'bar' }, <any> properties);
		...
		'update array item in property'() {
			...
			let propertiesChanged = shallowPropertyComparator.diffProperties({}, properties);
			...
			propertiesChanged = shallowPropertyComparator.diffProperties(propertiesChanged.properties, properties);
